...
try:
    ...
    print("  (1) SMTP_USERNAME must be the FULL email e.g. sales@petrobindglobal.com not 'sales'.")
    print("  (2) SMTP_PASSWORD = Spacemail mailbox password, NOT your Namecheap billing/account pw.")
    print("  (3) Spacemail does NOT use 'App Passwords' — use the real mailbox password.")
    print("  (4) If mailbox brand new: log in via https://www.spacemail.com/ webmail ONCE first to activate.")
    print("  (5) If you just changed pw: wait 2-3 minutes (Spacemail replicates slowly) then retry.")
